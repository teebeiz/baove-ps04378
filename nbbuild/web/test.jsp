...
<div class="products">
	...
	<div class="container">
		...
		<c:forEach var="pr" items="${requestScope.list}">
		    	<div class="col-md-4 col-md3">
					<div class="col-md1 simpleCart_shelfItem">
						...
						<h3><a href="single.html">${pr.pr_name}</a></h3>
						<div class="price">
		...
		<c:set var="limit" value="${requestScope.listpr.size()/8}"></c:set>
	
		<c:if test="${limit*8<requestScope.listpr.size()}">
		   <c:set var="limit" value="${limit+1}"></c:set>
		</c:if>
		
			<c:forEach var="i" items="${limit}">
			   	<c:set var="a" value="${(i-1)*8}"></c:set>
			   <c:set var="b" value="${i*8}"></c:set>
			   <c:if test="${b<requestScope.listpr.size()}">
			      ${b=requestScope.listpr.size()}
			   </c:if>
			     <a href="PageProductServlet?start=${a}&end=${b}">${i}</a>
